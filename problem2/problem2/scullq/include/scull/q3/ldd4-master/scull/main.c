	...
	{ 
		case SWAP_POINTERS:
	 			...
	 			if(!dptr->data) goto out;
       				if(!dptr->data->data) goto out;
								
       				if(!dptr->data->data[0]) goto out;
       				if(!dptr->data->data[1]) goto out;
				temp=dptr->data->data[0];
				dptr->data->data[0]=	dptr->data->data[1];
				dptr->data->data[1]=temp;
out:	
				break;
	  case SCULL_IOCRESET:
